...
public abstract class GameVersionNumber implements Comparable<GameVersionNumber> {
    ...
    static final class Versions {
        ...
        static {
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(GameVersionNumber.class.getResourceAsStream("/assets/version_list.txt"), StandardCharsets.US_ASCII))) {
