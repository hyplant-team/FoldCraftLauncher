...
public abstract class GameVersionNumber implements Comparable<GameVersionNumber> {
    ...
    static final class Versions {
        ...
        static {
            ...
            try (var reader = new BufferedReader(new InputStreamReader(GameVersionNumber.class.getResourceAsStream("/assets/version_data/versions.txt"), StandardCharsets.US_ASCII))) {
            ...
            try (var reader = new BufferedReader(new InputStreamReader(GameVersionNumber.class.getResourceAsStream("/assets/version_data/version-alias.csv"), StandardCharsets.US_ASCII))) {
                for (String line; (line = reader.readLine()) != null; ) {
                    if (line.isEmpty())
                        continue;
