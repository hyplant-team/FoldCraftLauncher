    ...
    private fun buildRows(): List<Row> {
        ...
        return listOf(
            ...
            Row.SeekBarRow(
                ...
                { prefs.getInt("videoBackgroundVolume", 10) },
            ...
            Row.SeekBarRow(
                R.string.settings_launcher_animation_speed, 20, 0,
