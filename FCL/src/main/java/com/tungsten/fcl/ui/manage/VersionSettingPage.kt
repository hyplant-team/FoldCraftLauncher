...
class VersionSettingPage(
    ...
    override fun onClick(view: View?) {
        ...
        if (view === binding.buttonInstallJava) {
            val url = FCLApplication.Prop.getProperty("java-plugin-url","null://")
            val builder = FCLAlertDialog.Builder(context)
            builder.setAlertLevel(FCLAlertDialog.AlertLevel.INFO)
        ...
        if (view === binding.buttonInstallRenderer) {
            val url = FCLApplication.Prop.getProperty("renderer-plugin-url","null://")
            val builder = FCLAlertDialog.Builder(context)
            builder.setAlertLevel(FCLAlertDialog.AlertLevel.INFO)
            builder.setCancelable(true)
        ...
        if (view === binding.buttonInstallDriver) {
            val url = FCLApplication.Prop.getProperty("driver-plugin-url","null://")
            val builder = FCLAlertDialog.Builder(context)
            builder.setAlertLevel(FCLAlertDialog.AlertLevel.INFO)
            builder.setCancelable(true)
            builder.setMessage(context.getString(R.string.message_install_plugin))
