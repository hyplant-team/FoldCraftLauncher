...
fun openLinkWithPopWebView(context: Context, link: String) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
        try {
            ...
            try {
                ...
                val freeformField = windowConfigurationClass.getDeclaredField("WINDOWING_MODE_FREEFORM")
                freeformField.isAccessible = true
